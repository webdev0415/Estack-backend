...
export class MerchantService {
  ...
  async updateSelf(
    ...
    if (!_.isEmpty(subscription)) {
      ...
      await this.subscriptionService.updatePeriod(dbSubscription, subscription);

      _.set(response, 'subscription', await this.subscriptionService.getByUserId(tokenUser._id));
    }
